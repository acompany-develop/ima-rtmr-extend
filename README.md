...
- [仕組み](docs/mechanism.md) - IMA 計測の RTMR 拡張、リプレイ検証、カーネル組み込みビルド
- [IMA ポリシーの注意点](docs/ima-policy.md) - ポリシーの書き込み順序、仮想ファイルシステムの除外
- [既知の問題](docs/known-issues.md) - 非アトミック性、開始地点の不可視性
...
- `CONFIG_IMA=y`, `CONFIG_KRETPROBES=y`
...
詳細は[既知の問題](docs/known-issues.md#問題-2-ima-ログの開始地点が-verifier-側からわからない)を参照してください。
